			...
			<div class="gtco-container">
				...
				<div class="row">
					<div class="col-sm-2 col-xs-12">
						<div id="gtco-logo"><a href="index.php"><img src="images/logo.png" alt=""></a></div>
					</div>
					...
					<div class="col-md-12 col-md-offset-0 text-left">
						<div class="display-t">
							<div class="display-tc">
								<div class="row">
									<div class="col-md-8">
										<h1 class="no-margin">VIVA TEKNIK!</h1>
										<br>
										<div class="gtco-container">
											<div class="row row-pb-md">
												<div class="col-md-8 gtco-widget gtco-footer-paragraph">
													<h3 style="color:#fff">Hidup UMM! Hidup TEKNIK! Hidup IF!</h3>
													<p>Jl. Teknik - Gedung Informatika
														Kampus Universitas Muhammadiyah Malang
														Jalan Raya Tlogomas, Lowokwaru, Malng 65144, Indonesia
														Telp : +62-81-2345678, 464318 (0341) 
														Fax : +62-81-2345678
													email : informatika@umm.ac.id</p>
												</div>
			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 gtco-heading text-center">
						<h2>Ini kami</h2>
						<p>Figur-figur penting yang berperan menyukseskan kegiatan pengmas dan donasi HMI 2023</p>
					</div>
				</div>
				<div class="row">
						...
						<div class="owl-carousel owl-carousel-carousel">
							<div class="item">
								<div class="gtco-staff">
									<img src="images/hmi-1.jpg" alt="" class="img-responsive">
									<h2>HMI A</h2>
							...
							<div class="item">
								<div class="gtco-staff">
									<img src="images/hmi-2.jpg" alt="" class="img-responsive">
									<h2>HMI B</h2>
							...
							<div class="item">
								<div class="gtco-staff">
									<img src="images/hmi-3.jpg" alt="" class="img-responsive">
									<h2>HMI C</h2>
									<p class="role">Ketua HMI</p>
								</div>
							</div>

							<div class="item">
								<div class="gtco-staff">
									<img src="images/hmi-4.jpg" alt="" class="img-responsive">
									<h2>HMI D</h2>
							...
							<div class="item">
								<div class="gtco-staff">
									<img src="images/hmi-5.jpg" alt="" class="img-responsive">
									<h2>HMI E</h2>
							...
							<div class="item">
								<div class="gtco-staff">
									<img src="images/hmi-6.jpg" alt="" class="img-responsive">
									<h2>HMI F</h2>
									<p class="role">Staff Divisi, Pengabdian Masyarakat</p>
