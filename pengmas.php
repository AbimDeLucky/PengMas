					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="has-dropdown">
								<a href="#" class="active">Kegiatan</a>
								<ul class="dropdown">
			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 gtco-heading text-center">
						...
						<p>HMI setiap tahun nya rutin mengadakan kegiatan pengabdian masyarakat yang tujuan utama nya adalah membantu masyarakat yang membutuhkan</p>
					</div>
				</div>
				<div class="row">
