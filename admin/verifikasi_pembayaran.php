...
<head>
    ...
    <title>SI Pengmas dan Donasi - HMI</title>
    <!-- Bootstrap Core CSS -->
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($sql) > 0) {
                                                    ...
                                                    while ($data = mysqli_fetch_assoc($sql)) {
                                                        ...
                                                        <td >'.$data['metode_donasi'].'</td>
                                                        <td >'.$data['nominal_donasi'].'</td>
                                                        <td> <a href="'.$data['location'].'">Lihat</a> </td>
                                                        
                                                        <td ><a href="delete_pembayaran.php?id_donasi='.$data['id_donasi'].'">Delete</a></td></tr>
