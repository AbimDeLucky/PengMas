                                        ...
                                        <div class="table-responsive m-t-40">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <?php
                                            //include('connect.php');
                                                    $sql = mysqli_query($con, "SELECT * FROM users where user_type='user' and user_status='tunda'");
                                                    if (mysqli_num_rows($sql) > 0) {
                                                        ...
                                                        while ($data = mysqli_fetch_assoc($sql)) {
                                                            ...
                                                            <td><button class="btn btn-success btn-xs"> <a href="konfir.php?id='.$data['id'].'" style="color: #fff; text-decoration: none;"> verifikasi</a></button> || <button type="button" data-toggle="modal" data-target="#myModal4" class="btn btn-danger btn-xs"style="color: #fff; text-decoration: none; "> Hapus</button> </td>
                                                            </tr>
                                                            ';
                                                             $idhapus =  "".$data['id']."";
                                                            ++$no;
